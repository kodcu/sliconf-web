...
class Floor extends React.Component {
   ...
   render() {
      ...
      return (
         <div key={floor.id} className="sponsor" data-id={floor.id} data-name={this.state.name} data-tag={tagId} style={{backgroundImage: "url(\"http://app.sliconf.com:8090/service/image/get/"+this.state.logo+"\")"}}>
