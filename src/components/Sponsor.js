...
class Sponsor extends React.Component {
   ...
   render() {
      ...
      return (
         <div key={sponsor.id} className="sponsor" data-id={sponsor.id} data-name={this.state.name} data-tag={tagId} style={{backgroundImage: "url(\"http://app.sliconf.com:8090/service/image/get/"+this.state.logo+"\")"}}>
