   ...
   return (
      <tr data-tip={"Click to Edit"} data-for="editTooltip">
         ...
         <td onClick={()=>{editTalk(talk.id)}} style={{textAlign:"center"}}>
            ...
            {talk.level===0 ?
            <svg data-tip="Beginner" xmlns="http://www.w3.org/2000/svg" fill="#111" version="1" viewBox="0 0 512 512">
            ...
            <svg data-tip="Intermediate" xmlns="http://www.w3.org/2000/svg" fill="#ff9800" version="1" viewBox="0 0 485 485">
            ...
            <svg data-tip="Advanced" xmlns="http://www.w3.org/2000/svg" fill="#f44336" version="1" viewBox="0 0 425 425">
